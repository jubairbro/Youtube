...
class AudioService : Service() {
    ...
    companion object {
        ...
        fun play() { inst?.player?.play() }
        fun pause() { inst?.player?.pause() }
        ...
        fun play(ctx: Context, url: String, t: String = "", a: String = "") {
            ...
            try {
                ...
                Log.e("AudioService", "start failed", e)
            }
        }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        when (intent?.action) {
            ...
            ACTION_UPDATE -> updateNotif()
            ACTION_URL -> {
                val url = intent.getStringExtra(EXTRA_URL)
                title = intent.getStringExtra(EXTRA_TITLE) ?: "YouTube Lite"
    ...
    private fun startFg() {
        ...
        try {
            ...
            Log.e("AudioService", "fg failed", e)
        }
    }
    ...
    private fun playUrl(url: String) {
        try {
            ...
            Log.e("AudioService", "play failed", e)
        }
    }
